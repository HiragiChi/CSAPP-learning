...
0000000000400da0 <main>:
  ...
  400ea7:	48 89 c7             	mov    %rax,%rdi;读入的是地址
...
0000000000400ee0 <phase_1>:
  400ee0:	48 83 ec 08          	sub    $0x8,%rsp ;rsp=rsp-8
  400ee4:	be 00 24 40 00       	mov    $0x402400,%esi ; esi=0x402400
  400ee9:	e8 4a 04 00 00       	callq  401338 <strings_not_equal>
  400eee:	85 c0                	test   %eax,%eax ;% handling register(ZF SF ) to judge if the eax is 0
...
0000000000400fce <func4>:
  ...
  400fe2:	39 f9                	cmp    %edi,%ecx;7<=edi(第一个参数)
  400fe4:	7e 0c                	jle    400ff2 <func4+0x24>;
  400fe6:	8d 51 ff             	lea    -0x1(%rcx),%edx;否则edx-6返回
...
000000000040100c <phase_4>:;do not use stack for calling function 
  ...
  40105d:	48 83 c4 18          	add    $0x18,%rsp;回收还得自己做啊
  401061:	c3                   	retq   

0000000000401062 <phase_5>:
  401062:	53                   	push   %rbx
  401063:	48 83 ec 20          	sub    $0x20,%rsp
  401067:	48 89 fb             	mov    %rdi,%rbx;input address
  40106a:	64 48 8b 04 25 28 00 	mov    %fs:0x28,%rax;设计栈的保护
  401071:	00 00 
  ...
  40108b:	0f b6 0c 03          	movzbl (%rbx,%rax,1),%ecx;begin
  40108f:	88 0c 24             	mov    %cl,(%rsp);rsp read here,最后8位。
  401092:	48 8b 14 24          	mov    (%rsp),%rdx
  401096:	83 e2 0f             	and    $0xf,%edx;取最后四位
  401099:	0f b6 92 b0 24 40 00 	movzbl 0x4024b0(%rdx),%edx;see register
  4010a0:	88 54 04 10          	mov    %dl,0x10(%rsp,%rax,1);取最后两位
  4010a4:	48 83 c0 01          	add    $0x1,%rax
  4010a8:	48 83 f8 06          	cmp    $0x6,%rax
  4010ac:	75 dd                	jne    40108b <phase_5+0x29>;rsp+10那里
  ...
  4010d9:	48 8b 44 24 18       	mov    0x18(%rsp),%rax;protect stack
...
00000000004010f4 <phase_6>:
  ...
  401114:	4c 89 ed             	mov    %r13,%rbp;in read_six? r13 change? 
  401117:	41 8b 45 00          	mov    0x0(%r13),%eax
  40111b:	83 e8 01             	sub    $0x1,%eax
  40111e:	83 f8 05             	cmp    $0x5,%eax
  401121:	76 05                	jbe    401128 <phase_6+0x34>;first input <= 6
  401123:	e8 12 03 00 00       	callq  40143a <explode_bomb>
  401128:	41 83 c4 01          	add    $0x1,%r12d;r12d is what
  40112c:	41 83 fc 06          	cmp    $0x6,%r12d
  401130:	74 21                	je     401153 <phase_6+0x5f>
  401132:	44 89 e3             	mov    %r12d,%ebx;ebx=r12d
  ;loop1
  401135:	48 63 c3             	movslq %ebx,%rax;?为什么rax=1 数字的位数如何确定？（slq情况下）
  401138:	8b 04 84             	mov    (%rsp,%rax,4),%eax;read next
  40113b:	39 45 00             	cmp    %eax,0x0(%rbp); 每一位与第一位不能相同
  ...
  401174:	eb 21                	jmp    401197 <phase_6+0xa3>  ;loop2
  ...
  401183:	ba d0 32 60 00       	mov    $0x6032d0,%edx;0x14c
...
000000000040131b <string_length>:; return eax as the length of the string;  from rdi on to the first address in which 0 is stored;
  40131b:	80 3f 00             	cmpb   $0x0,(%rdi)
  40131e:	74 12                	je     401332 <string_length+0x17>
  401320:	48 89 fa             	mov    %rdi,%rdx
  401323:	48 83 c2 01          	add    $0x1,%rdx
  401327:	89 d0                	mov    %edx,%eax;repeated work?
  401329:	29 f8                	sub    %edi,%eax
  40132b:	80 3a 00             	cmpb   $0x0,(%rdx) 
  40132e:	75 f3                	jne    401323 <string_length+0x8>
  401330:	f3 c3                	repz retq 
  401332:	b8 00 00 00 00       	mov    $0x0,%eax
  401337:	c3                   	retq   ;让上层函数继续调用

0000000000401338 <strings_not_equal>:
  401338:	41 54                	push   %r12
  40133a:	55                   	push   %rbp
  40133b:	53                   	push   %rbx
  40133c:	48 89 fb             	mov    %rdi,%rbx; 这些是都用做数据寄存器了吗
  40133f:	48 89 f5             	mov    %rsi,%rbp 
  401342:	e8 d4 ff ff ff       	callq  40131b <string_length>
  401347:	41 89 c4             	mov    %eax,%r12d ;r12d is string length from rdi
  40134a:	48 89 ef             	mov    %rbp,%rdi ;
  40134d:	e8 c9 ff ff ff       	callq  40131b <string_length>
  401352:	ba 01 00 00 00       	mov    $0x1,%edx 
  401357:	41 39 c4             	cmp    %eax,%r12d ;from rsi   from rdi string the same?
  40135a:	75 3f                	jne    40139b <strings_not_equal+0x63> ;not same; eax=1
  40135c:	0f b6 03             	movzbl (%rbx),%eax ;
  40135f:	84 c0                	test   %al,%al;(rdi)的前16位是0 返回0
  401361:	74 25                	je     401388 <strings_not_equal+0x50>
  401363:	3a 45 00             	cmp    0x0(%rbp),%al;(rdi)前16位和(rsi)相同 返回 
  401366:	74 0a                	je     401372 <strings_not_equal+0x3a>;没看
  401368:	eb 25                	jmp    40138f <strings_not_equal+0x57>;不同 返回1
  ...
  40137d:	84 c0                	test   %al,%al; rbx=0 return 0(tested length before)
...
000000000040145c <read_six_numbers>:
  ...
  40148a:	e8 61 f7 ff ff       	callq  400bf0 <__isoc99_sscanf@plt> ;eax+1在哪里？
